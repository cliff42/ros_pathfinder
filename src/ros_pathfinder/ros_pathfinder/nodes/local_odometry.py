...
class LocalOdometry(Node):
    ...
    ODOM_FRAME = "odom"
    BASE_FRAME = "base_link"  # base_link moves with the robot
    ...
    def __init__(self):
        ...
        self._estimator = WheelIMUOdometry(
            wheel_radius_m=self.wheel_radius_m,
            encoder_distance_scale=self.encoder_distance_scale,
        )
    ...
    def joint_state_callback(self, msg: JointState) -> None:
        ...
        if odometry_state is not None:
            ...
            # The robot operates in 2D at an assumed fixed height.
            ...
            odometry_msg.twist.twist.angular.z = (
                odometry_state.angular_vel_rad_s
            )
    ...
    def _get_parameters(self) -> None:
        ...
        self.encoder_distance_scale = self.get_parameter(
